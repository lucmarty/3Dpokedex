  ...
  return (
    <div className="relative flex flex-row items-center justify-center">
      ...
      <button
        ...
        className="fixed rounded-xl left-10 bottom-3 transform -translate-y-1/2 bg-gray-100 px-6 py-3 shadow-lg focus:outline-none ring-0 hover:ring-2 hover:ring-red-600 flex flex-col items-center"
      >
            <img
      ...
      <button
        ...
        className="fixed rounded-xl right-10 bottom-3 transform -translate-y-1/2 bg-gray-100 px-6 py-3 shadow-lg focus:ouline-none ring-0 hover:ring-2 hover:ring-red-600 flex flex-col items-center"
      >
            <img
